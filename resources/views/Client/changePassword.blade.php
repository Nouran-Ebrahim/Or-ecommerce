            ...
            <div class="col-lg-8 col-12">
                <div class="tab-content profile-content your-orders" id="v-pills-tabContent">
                    <div class="tab-pane fade " id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab"
                        ...
                        <p>
                            @lang('trans.From your account  you can view your recent orders, manage your shipping and billing addresses, and edit your password and account details.')
                        </p>
                        <div class="view-item">
                    ...
                    <div class="tab-pane fade show active" id="v-pills-edit" role="tabpanel"
                        ...
                        <section class="edit-password-section">
                            <h2>@lang('trans.EDIT PASSWORDS')</h2>
                            <form method="POST" action="{{ route('client.update.password') }}" class="contact-us-form">
                                @csrf
                                @method('put')
                                <input type="password" name="current" placeholder="@lang('trans.Current password')" />
                                @error('current')
                                    <p class="alert alert-danger" style="color:red;">{{ $message }}</p>
                                @enderror
                                <input name="password" type="password" placeholder="@lang('trans.New password')" />
                                @error('password')
                                    <p class="alert alert-danger" style="color:red;">{{ $message }}</p>
                                @enderror
                                <input name="password_confirmation" type="password" placeholder="@lang('trans.Confirm new password')" />
