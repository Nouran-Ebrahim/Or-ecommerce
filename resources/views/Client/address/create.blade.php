                ...
                <div class="tab-content profile-content your-orders" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane show active" id="v-pills-address" role="tabpanel"
                        ...
                        <section class="edit-profile-form">
                            <form method="POST" action="{{ route('client.address.store') }}" class="contact-us-form">
                                @csrf
                                <div>
                                ...
                                <div class="input-name">
                                    ...
                                    <div style="width: 48%">
                                        <input value="{{ old('zone') }}" style="  width: 100%;" type="text"
                                ...
                                <input value="{{ old('road') }}" class="contacts-input" type="text" name="road"
                                    placeholder="@lang('trans.road')" />
                                @error('road')
                                    <p class="alert alert-danger">{{ $message }}</p>
                                @enderror
                                <input value="{{ old('building_no') }}" class="contacts-input" name="building_no"
                                    type="text" placeholder="@lang('trans.building_no')" />
                                @error('building_no')
                                    <p class="alert alert-danger">{{ $message }}</p>
                                @enderror
                                <input value="{{ old('note') }}" class="contacts-input" name="note" type="text"
                                ...
                                <div class="d-flex">
                                    <input type="checkbox" style="width: 2.2rem;"
                                        class="form-check-input save-input border" value="1" name="default"
                                        id="save" />
